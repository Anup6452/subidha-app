...
class _TermsandconditionPageState extends State <TermsandconditionPage> {
  ...
  Widget build(BuildContext context) {
   ...
   //  alignment: Alignment.topCenter,
     children: <Widget>[
      new Text("Terms and Condition",textAlign: TextAlign.center,),
       SizedBox( height: 10.0),
       new Text("Please review our terms of use and privacy policy carefully before downloading.",textAlign:TextAlign.left,),
       SizedBox(height: 10.0),
      ...
      //),
       CheckboxListTile(
         ...
         onChanged: (bool newValue) {
           ...
           RaisedButton(
             child: Text('Submit', style: TextStyle(color: Theme
                 .of(context)
                 .accentColor,),),
             onPressed: () {
